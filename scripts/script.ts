...
fetch(
  'https://api.openweathermap.org/data/2.5/weather?lat=43.30&lon=5.37&units=metric&appid=09fb599dd2980efff0d48342ac50f502'
)
  .then((res) => res.json())
  .then((data) => {
...
fetch(
  'https://api.openweathermap.org/data/2.5/weather?lat=41.89&lon=12.48&units=metric&appid=09fb599dd2980efff0d48342ac50f502'
)
  .then((res) => res.json())
  .then((data) => {
...
fetch(
  'https://api.openweathermap.org/data/2.5/weather?lat=42.33&lon=10.31&units=metric&appid=09fb599dd2980efff0d48342ac50f502'
)
  .then((res) => res.json())
  .then((data) => {
